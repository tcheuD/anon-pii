...
When an incident does occur, it is important to report it promptly. To report a possible violation, please open a private report through [GitHub Security Advisories](https://github.com/tcheuD/anon-pii/security/advisories/new) and prefix the title with `[Conduct]`. Reports are received only by the maintainers and are kept confidential.
