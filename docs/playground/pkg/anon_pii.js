...
export class Engine {
    ...
    anonymize(text) {
        ...
        try {
            ...
            wasm.engine_anonymize(retptr, this.__wbg_ptr, ptr0, len0);
     ...
     */
    mapping_len() {
        const ret = wasm.engine_mapping_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    restore(text) {
        ...
        try {
            ...
            const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
            const len0 = WASM_VECTOR_LEN;
            wasm.engine_restore(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred2_0 = r0;
            deferred2_1 = r1;
 ...
 * @returns {number}
 */
export function entity_type_count() {
    const ret = wasm.entity_type_count();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function pattern_count() {
    const ret = wasm.pattern_count();
    return ret >>> 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('anon_pii_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
